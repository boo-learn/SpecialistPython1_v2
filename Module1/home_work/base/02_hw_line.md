...
print ("Программа расчитывает площать круга по его радиусу")

r = float(input("Введите значение радиуса круга в виде вещественного числа: "))
s = math.pi*(r**2)


print("Плащадь круга составляет", s)
