...
```circle_radius = float(input('Введите радиус круга:')) # Радиус круга
import math
pi = math.pi # Число pi из библиотеки math
area_of_the_circle = pi*circle_radius**2 # Площадь круга
print('Площадь круга:', area_of_the_circle)
```
