...
print("Длина Московской кольцевой автомобильной дороги — 109 километров.")
print("Байкер стартует с нулевого километра МКАД и едет со скоростью v километров в час.")
...
print("Байкер остановится на отметке: ", int(math.fabs(a)))
