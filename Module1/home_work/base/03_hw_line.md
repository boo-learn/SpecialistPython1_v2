...
# 03_hw_line.md
# "МКАД"
# Длина МКАД - 109 км, определить его местонахождение по скорости и времени в пути

speed = float(input("Введите скорость мотоциклиста: "))
time = float(input("Введите количество часов в дороге: "))
point = (speed * time) % 109

print("Мотоциклист находится на отметке",point,"км МКАД")
```
