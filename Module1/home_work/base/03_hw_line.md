...
time = int(input("Введите время движения байкера: "))

way  = speed*time #пройденный путь
circle = way//109 #сколько полных кругов прошел
point = way - 109*circle #на каком километре остановился

# print("Пройденный путь :", way)
# print("Полных кругов : ", circle)
print("Отметка на которой остановился :", point)
```
