...
print ("Программа переводит градусы по Цельсию в градусы по Фаренгейту")

degreesC = int(input("Введите значение градусов по Цельсию: "))
degreesF = (degreesC * (9/5)+32)


print("Соответствует ", degreesF, "градусам по Фаренгейту")
