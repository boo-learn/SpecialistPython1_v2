...
print(f"Имя и Фамилию сотрудника с самой высокой низкой: {', '.join(names)}")

print(f"Среднеарифметическая зарплата всех сотрудников: {sum(salaries) / len(salaries):.2f}")
