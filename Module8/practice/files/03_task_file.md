...
for el in prices_str:
    number = float(el)
    prices.append(number)

f.close()

print(f"На какую сумму было продано товаров? - {sum(prices):.2f}")
print(f"Цену самого дорогого товара - {max(prices)}")
print(f"Цену самого дешевого товара - {min(prices)}")
