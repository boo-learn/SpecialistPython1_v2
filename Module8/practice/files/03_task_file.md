...
prises = ()
for line in f:
    prises += tuple(map(float, line.split()))

print(f"Товаров продано на сумму: {sum(prises):.2f}")
print(f"Цена самого дорогого товара: {max(prises)}")
print(f"Цена самого дешевого товара: {min(prises)}")
