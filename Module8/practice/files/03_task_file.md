...
```python
file = open("dir/sold.txt", "r", encoding="utf-8")
numbers = []
...
print("Сумма:",round(sum(numbers),2))
print("Максимальная цена:",round(max(numbers),2))
print("Минимальная цена:",round(min(numbers),2))
