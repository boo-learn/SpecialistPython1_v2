...
```python
x = int(input("Введите координату х интересующей Вас точки: "))
y = int(input("Введите координату y интересующей Вас точки: "))
xr = int(input("Введите координату х центра круга: "))
yr = int(input("Введите координату y центра круга: "))
