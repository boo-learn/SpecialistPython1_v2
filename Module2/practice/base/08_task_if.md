...
xr = int(input('Введите координату центра xr: '))
yr = int(input('Введите координату центра yr: '))



r = int(input('Радиус круга: '))

if 0 <= x_coord - xr <= r and 0 <= y_coord - yr <= r:
    print("Да, точка принадлежит окружности")
else:
