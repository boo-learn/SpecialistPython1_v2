...
```python
x = int(input("введите координаты точки А(х): "))
y = int(input("введите координаты точки А(у): "))
rx = int(input("введите координаты центра круга B(rх): "))
ry = int(input("введите координаты центра круга B(rу): "))
r = int(input("введите радиус круга: "))
dist = ((rx - x) ** 2 + (ry - y) ** 2) ** (1 / 2)
if dist <= r:
    print("Да")
else:
    print("Нет")
