...
```python
a = int(input("введите сторону треуольника "))
b = int(input("введите сторону треуольника "))
c = int(input("введите сторону треуольника "))
print("Существует" if a+b>c and a+c>b and b+c>a else "Не существует")
```
