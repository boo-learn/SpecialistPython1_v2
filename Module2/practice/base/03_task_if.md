...
#решение 1
x_rub = int(input("Сколько у Вас денег?"))
y_price = int(input("Стоимость покупки:"))
if x_rub >= y_price :
    print("Покупка оформлена, у Вас осталось,", x_rub - y_price , "рублей")
elif x_rub <= y_price :
    print("Недостаточно денежек")
```
